...
<section class="content-header">
    <h1> Donor  <small><?php echo $button ?></small> <a href="<?php echo site_url(Backend_URL . 'donor') ?>" class="btn btn-default">Back</a> </h1>
    <ol class="breadcrumb">
...
<section class="content">       
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Register New Donor</h3>
        </div>
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">                    
                    <input type="number" class="form-control" name="contact" id="contact" placeholder="Mobile Number" value="<?php echo $contact; ?>" />
            ...
            <div class="form-group">
                <label for="status"  class="col-sm-2 control-label">Send Welcome SMS:</label>
                <div class="col-sm-10"  style="padding-top:8px;">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10 col-md-offset-2">
                    ...
                    <a href="<?php echo site_url(Backend_URL . 'donor') ?>" class="btn btn-default">Cancel</a>
                </div>                
            </div>
            <?php echo form_close(); ?>
        </div>
