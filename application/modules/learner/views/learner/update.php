...
<section class="content">
    <?php echo learnerTabs($a_id, 'update'); ?>
    ...
    <div class="tx-card">
        ...
        <div class="tx-body">
            ...
            <div class="tx-row">
                ...
                <div class="tx-ctrl">
                    <select class="tx-select" name="batch_id" id="batch_id">
                        <?php foreach($batch_list as $b_id => $b_name) { ?>
                            <option value="<?php echo $b_id; ?>" <?php echo ($batch_id == $b_id) ? 'selected' : ''; ?>><?php echo $b_name; ?></option>
                        <?php } ?>
                    </select>
            ...
            <div class="tx-row">
                ...
                <div class="tx-ctrl">
                    <input type="text" class="tx-input" name="nid" id="nid" placeholder="National ID" value="<?php echo $nid; ?>" />
            ...
            <div class="tx-row">
                ...
                <div class="tx-ctrl">
                    <input type="text" class="tx-input" name="primary_mobile" id="primary_mobile" placeholder="Mobile Number" value="<?php echo $primary_mobile; ?>" />
            ...
            <div class="tx-row">
                ...
                <div class="tx-ctrl">
                    <input type="text" class="tx-input" name="second_contact_person" id="second_contact_person" placeholder="Contact Person" value="<?php echo $second_contact_person; ?>" />
            ...
            <div class="tx-row">
                ...
                <div class="tx-ctrl">
                    <input type="text" class="tx-input" name="second_contact_mobile" id="second_contact_mobile" placeholder="Mobile Number" value="<?php echo $second_contact_mobile; ?>" />
