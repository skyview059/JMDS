    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                <label for="batch_id" class="col-sm-2 control-label"><sup>*</sup> Batch:</label>
                <div class="col-sm-6">
            ...
            <div class="form-group">
                <label for="district_id" class="col-sm-2 control-label"><sup>*</sup> District :</label>
                <div class="col-sm-6">
            ...
            <div class="form-group">
                <label for="primary_mobile" class="col-sm-2 control-label"><sup>*</sup> Primary Mobile :</label>
                <div class="col-sm-6">
