...
<section class="content-header">
    <h1>Driving <small><?php echo $button; ?></small>
        <a href="<?php echo site_url(Backend_URL . 'driving'); ?>" class="btn btn-default">Back</a>
    </h1>
    <ol class="breadcrumb">
...
<section class="content">
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Add a Driving Record</h3>
            <p class="text-muted" style="margin:6px 0 0;">
                This will create a raw <code>drivings</code> row and an initial <b>Queued</b> log.
            </p>
        </div>
