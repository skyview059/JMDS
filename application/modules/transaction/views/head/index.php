...
<section class="content-header">
    <h1> Head  <small>Control panel</small> <?php echo anchor(site_url( Backend_URL . 'transaction/head/create'),' + Add New', 'class="btn btn-default"'); ?> </h1>
    <ol class="breadcrumb">
    ...
    <div class="box">            
        <div class="box-header with-border">                                   
            <div class="col-md-3 col-md-offset-9 text-right">
                <form action="<?php echo site_url( Backend_URL .'transaction/head'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        <input type="text" class="form-control" name="q" value="<?php echo $q; ?>">
                        <span class="input-group-btn">
                            <?php if ($q <> '') { ?>
                                <a href="<?php echo site_url( Backend_URL .'transaction/head'); ?>" class="btn btn-default">Reset</a>
                            <?php } ?>
