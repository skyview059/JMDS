...
<section class="content">
    <?php echo transactionTabs($id, 'update'); ?>
    ...
    <div class="tx-card">
                        ...
                        <div class="tx-half">
                            <select class="tx-select" name="head_id" id="head_id">
                                <?php if (isset($head_list) && is_array($head_list)) {
                                    foreach ($head_list as $hid => $name) { ?>
                                        <option value="<?php echo $hid; ?>" <?php echo ($head_id == $hid) ? 'selected' : ''; ?>><?php echo $name; ?></option>
                                <?php }
                                } ?>
                            </select>
                        </div>
                        <div class="tx-half">
                            ...
                            <select class="tx-select" name="subhead_id" id="subhead_id">
                                <?php if (isset($subhead_list) && is_array($subhead_list)) {
                                    foreach ($subhead_list as $sid => $name) { ?>
                                        <option value="<?php echo $sid; ?>" <?php echo ($subhead_id == $sid) ? 'selected' : ''; ?>><?php echo $name; ?></option>
                                <?php }
                                } ?>
                            </select>
                        </div>
                ...
                <div class="tx-ctrl">
                    <div class="tx-inline-radios" id="source_id">
                        ...
                        if (isset($source_list) && is_array($source_list)) {
                            foreach ($source_list as $sid => $name) {
                                if ($sid === '' || $sid === null) { continue; }
                                $is_checked = ($selected_source !== null)
                                    ? ($selected_source === (int) $sid)
                                    : $first_source;
                        ?>
                                <label class="tx-radio">
                                    <input type="radio" name="source_id" value="<?php echo (int) $sid; ?>"
                ...
                <div class="tx-ctrl">
                    <div class="tx-inline-radios">
                        ...
                        <?php if (isset($batch_list) && is_array($batch_list)) {
                            foreach ($batch_list as $bid => $name) {
                                if ($bid === '' || $bid === null) { continue; } ?>
                                <label class="tx-radio">
                                    <input type="radio" name="batch_id" value="<?php echo (int) $bid; ?>"
                                           <?php echo ($selected_batch === (int) $bid) ? 'checked' : ''; ?>>
                                    <?php echo htmlspecialchars($name); ?>
                                </label>
                        <?php }
                        } ?>
        ...
        <div class="tx-foot">
            ...
            <button type="submit" class="tx-btn-save"><i class="fa fa-floppy-o"></i> <?php echo $button; ?> Transaction</button>
        </div>
    </div>
    <?php echo form_close(); ?>
</section>
